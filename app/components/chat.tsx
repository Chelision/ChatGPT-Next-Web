...
import FileIcon from "../icons/book.svg";
...
//上传图片代码
  ...
  function readTextFile(file:any){
    ...
    reader.onload = function(e) {
      ...
      doSubmit(String(e.target?.result))
    }
  }
    ...
    reader.onload = (e: ProgressEvent<FileReader>) => {
      if (e.target?.result && typeof e.target.result !== 'string') {
        ...
        mammoth.extractRawText({ arrayBuffer })
          .then(result => {
            console.log('Word内容:', result.value);
  ...
  function readPdfFile(url: String) {
    ...
    loadingTask.promise
        .then(async (pdf) => {
          ...
          doSubmit(pdfText.value)
          console.log(pdfText.value, 999)
        })
        .catch((reason) => {
  ...
  function readXlsxFile(file: File) {
    ...
    reader.onload = (e) => {
      ...
      doSubmit(JSON.stringify(excelData))
    };
    reader.readAsArrayBuffer(file);
  }
  // 快捷键 shortcut keys
