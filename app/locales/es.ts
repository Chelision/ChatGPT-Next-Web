...
const es: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ Si deseas comenzar sin configuración, [haz clic aquí para empezar a chatear inmediatamente 🚀](${SAASC_Hat_UTM_URL})
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Oferta de lanzamiento de KnChat AI, desbloquea OpenAI o1, GPT-4o, Claude-3.5 y los últimos grandes modelos",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        SubTitle:
          "Officially maintained by KnChat, zero configuration ready to use, supports the latest large models like OpenAI o1, GPT-4o, and Claude-3.5",
        ChatNow: "Chat Now",
      },
