...
import { SAASC_Hat_UTM_URL } from "@/app/constant";
...
const pt: PartialLocaleType = {
  ...
  Error: {
   ...
   \\ 1️⃣ Se você quiser começar sem configuração, [clique aqui para começar a conversar imediatamente 🚀](${SAASC_Hat_UTM_URL})
...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Oferta de Lançamento do KnChat AI, desbloqueie o OpenAI o1, GPT-4o, Claude-3.5 e os mais recentes grandes modelos agora",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usar KnChat AI",
        Label: "(A solução mais econômica)",
        SubTitle:
          "Mantido oficialmente pelo KnChat, pronto para uso sem configuração, suporta os mais recentes grandes modelos como OpenAI o1, GPT-4o e Claude-3.5",
