...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 对话遇到了一些问题，不用慌:
       \\ 1️⃣ 想要零配置开箱即用，[点击这里立刻开启对话 🚀](${SAASC_Hat_UTM_URL})
  ...
  Auth: {
    ...
    TopTips:
      "🥳 KnChat AI 首发优惠，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（性价比最高的方案）",
        SubTitle:
          "由 KnChat 官方维护, 零配置开箱即用，支持 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
