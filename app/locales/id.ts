...
const id: PartialLocaleType = {
  ...
  Error: {
   ...
   \\ 1️⃣ Jika Anda ingin memulai tanpa konfigurasi, [klik di sini untuk mulai mengobrol segera 🚀](${SAASC_Hat_UTM_URL})
...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Penawaran Peluncuran KnChat AI, buka OpenAI o1, GPT-4o, Claude-3.5 dan model besar terbaru sekarang",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Gunakan KnChat AI",
        Label: "(Solusi paling hemat biaya)",
        SubTitle:
          "Dikelola secara resmi oleh KnChat, siap digunakan tanpa konfigurasi, mendukung model besar terbaru seperti OpenAI o1, GPT-4o, dan Claude-3.5",
